...
import cv2
import numpy as np
from src.utils.ops import xywhn2xywh, xywh2xyxy
...
def plot_yolo_labels(
    ...
    Args:
        ...
        id2label (dict[int, str], optional): Mapping from class_id to class_name.
    ...
    """
    if id2label is None:
        id2label = {class_id: str(class_id) for class_id in class_ids}
